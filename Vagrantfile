...
Vagrant.configure("2") do |config|
    ...
    if which('ansible-playbook')
        ...
        config.vm.provision "resume", type: "ansible" do |resume|
            ...
            resume.raw_arguments = "--limit @/vagrant/ansible/playbook.retry"
        end
    else
        config.vm.provision :shell, path: "ansible/windows.sh", args: ["default"], keep_color: true
    end

    ENV['VAGRANT_SYNCED_FOLDER'] ||= "./"
